...
class Auth extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(body: Container(width: size.width,decoration: BoxDecoration(color: Colors.indigo.shade900),child:Column(children: [
      SizedBox(height: size.height/3,),
      Text("Welcome",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w700,color: Colors.white),),
      SizedBox(height: 10,),
      Text("Login/SignUp to continue:",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w500,color: Colors.white),),
      SizedBox(height: size.height/10,),
      FutureBuilder(
        future: Provider.of<Data>(context).initializeFirebase(context: context),
